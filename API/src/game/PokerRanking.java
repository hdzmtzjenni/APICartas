...
// PokerRanking is an enum used to representate the Poker Plays and adds an int value in order to compare them as a Value Rank. The most valuable is represented with a 10
...
public enum PokerRanking {
    ...
    private PokerRanking(int ranking) { // Private Constructor 
        this.ranking=ranking;
    }
    public int getRanking() { // Function that returns the int value of the PokerRanking Instance 
        return this.ranking;
    } 
